...
`
  ...
  mutation addImage($tripId: ID!, $image: Upload!, $description: String) {
    addImage(tripId: $tripId, image: $image, description: $description) {
      _id
      images {
        _id
        url
...
export const DELETE_IMAGE = gql`
  mutation deleteImage($tripId: ID!, $imageId: ID!) {
    deleteImage(tripId: $tripId, imageId: $imageId) {
      _id
      images {
        _id
        url
